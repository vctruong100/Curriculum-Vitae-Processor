...
echo ==============================================
echo   CV Pipeline - Three Files (FreeSimpleGUI)
echo ==============================================
echo.
...
REM Install free GUI + docx if missing
...
REM Run the three-file GUI from Processors
cd /d "%~dp0Processors"
echo Starting GUI...
echo.
py -3 "%~dp0Processors\cv_gui_threefile.py" 1>>"%LOG%" 2>&1
